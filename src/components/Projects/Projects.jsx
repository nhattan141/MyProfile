            ...
            <motion.div animate={animationLeft}>
                <div className="box">
                    ...
                    <div className="content">
                        ...
                        <a href='https://github.com/nhattan141/2T-Music' target="_blank" rel="noopener noreferrer">Go to Git</a>
                    </div>
                </div>
            </motion.div>
                ...
                <div className="box blur1">
                    ...
                    <div className="content">
                        ...
                        <p>
                            ...
                            You can buy products what the shop have, add products into cart.
                            You can also manage your profile, order history and change your password.
                        </p>
                        <a href='https://github.com/nhattan141/ShopThoITrang' target="_blank" rel="noopener noreferrer">Go to Git</a>
                    </div>
                </div>
            </motion.div>
            <motion.div animate={animationRight}>
                <div className="box blur2">
                    ...
                    <div className="content">
                        ...
                        <a href='https://github.com/nhattan141/MyProfile' target="_blank" rel="noopener noreferrer">Go to Git</a>
                    </div>
                </div>
            </motion.div>
        </div >
